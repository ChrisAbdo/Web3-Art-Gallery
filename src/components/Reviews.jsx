...
import pic4 from 'src/images/ai4.webp'
import pic5 from 'src/images/ai5.webp'
import pic6 from 'src/images/ai6.webp'
import pic7 from 'src/images/ai7.webp'
import pic8 from 'src/images/ai8.webp'
import pic9 from 'src/images/ai9.webp'
import pic10 from 'src/images/ai10.webp'
import pic11 from 'src/images/ai11.webp'
import pic12 from 'src/images/ai12.webp'
import pic13 from 'src/images/ai13.webp'
import pic14 from 'src/images/ai14.webp'
...
function Review({ title, body, author, rating, image, className, ...props }) {
  ...
  return (
    <figure
      className={clsx(
        'animate-fade-in rounded-3xl bg-white dark:bg-[#333] p-6 opacity-0 shadow-md shadow-gray-900/5',
        className
      )}
...
function ReviewGrid() {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-x-0 top-0 h-32 bg-gradient-to-b from-gray-50 dark:from-black" />
      <div className="pointer-events-none absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-gray-50 dark:from-black" />
    </div>
  )
}
  ...
  return (
    ...
    >
      <Container>
        <h2
          id="reviews-title"
          className="text-3xl font-medium tracking-tight text-gray-900 dark:text-white sm:text-center"
        >
          Every piece of art is a masterpiece
        </h2>
        <p className="mt-2 text-lg text-gray-600 dark:text-white sm:text-center">
